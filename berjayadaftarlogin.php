...
<title>BERJAYA DAFTAR LOGIN</title>
...
<body bgcolor="#F4FFE4" onload="MM_popupMsg('pendaftaran anda berjaya, terima kasih')" >
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
    ...
    <table border="0" cellspacing="0" cellpadding="2" width="500">
        <tr>
          <td width="496" class="pageName"><h1 align="center" class="style1">TERIMA KASIH KERANA MENDAFTAR</h1></td>
        </tr>
        <tr>
          <td class="bodyText"><h1 align="center" >LOGIN</h1></td>
		</tr>
      </table>	</td>
    <td width="100%">&nbsp;</td>
  </tr>
