...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO datamurid (nokp, nama, tingkatan, kelas, jantina, kaum, agama) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
 ...
 <tr>
    ...
    <table border="0" cellspacing="0" cellpadding="2" width="1044">
        <tr>
          <td width="1040" class="pageName"><div align="center">PENDAFTARAN MURID</div></td>
        </tr>
        <tr>
